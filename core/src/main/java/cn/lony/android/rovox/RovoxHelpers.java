 ...
 */
public final class RovoxHelpers {
    private RovoxHelpers() {
    }
    ...
    public static Class<?> findClass(String className, ClassLoader classLoader) {
        if (classLoader == null)
            classLoader = RovoxBridge.BOOTCLASSLOADER;
        try {
     ...
     * for details.
     */
    public static RX_MethodHook.Unhook findAndHookMethod(Class<?> clazz, String methodName, Object... parameterTypesAndCallback) {
        if (parameterTypesAndCallback.length == 0 || !(parameterTypesAndCallback[parameterTypesAndCallback.length - 1] instanceof RX_MethodHook))
            throw new IllegalArgumentException("no callback defined");

        RX_MethodHook callback = (RX_MethodHook) parameterTypesAndCallback[parameterTypesAndCallback.length - 1];
        Method m = findMethodExact(clazz, methodName, getParameterClasses(clazz.getClassLoader(), parameterTypesAndCallback));

        return RovoxBridge.hookMethod(m, callback);
    }
     ...
     * an anonymous subclass of {@link RX_MethodHook} or {@link RX_MethodReplacement}.
     *
     * <p><b>Example</b>
     ...
     */
    public static RX_MethodHook.Unhook findAndHookMethod(String className, ClassLoader classLoader, String methodName, Object... parameterTypesAndCallback) {
    ...
    private static Class<?>[] getParameterClasses(ClassLoader classLoader, Object[] parameterTypesAndCallback) {
        ...
        for (int i = parameterTypesAndCallback.length - 1; i >= 0; i--) {
            ...
            if (type instanceof RX_MethodHook)
                continue;
     ...
     * for details.
     */
    public static RX_MethodHook.Unhook findAndHookConstructor(Class<?> clazz, Object... parameterTypesAndCallback) {
        if (parameterTypesAndCallback.length == 0 || !(parameterTypesAndCallback[parameterTypesAndCallback.length - 1] instanceof RX_MethodHook))
            throw new IllegalArgumentException("no callback defined");
     ...
     * for details.
     */
    public static RX_MethodHook.Unhook findAndHookConstructor(String className, ClassLoader classLoader, Object... parameterTypesAndCallback) {
